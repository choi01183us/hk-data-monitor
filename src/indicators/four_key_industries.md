---
title: 四大行業佔本地生產總值比重
keywords: 四大行業 金融 旅遊 貿易 物流 專業服務 產業結構 統計處 industries
---
...
const indicator = await FileAttachment("../data/four_key_industries.json").json();
```

<!-- 中文標題嘅 slug 會變空字串,anchor 撳唔到,所以自己寫 id。 -->
<h1 id="four-key-industries">四大行業佔本地生產總值比重</h1>
