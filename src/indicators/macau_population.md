...
const indicator = await FileAttachment("../data/macau_population.json").json();
```

<h1 id="macau-population">澳門年末人口</h1>
...
<h2 id="chart">2025 年底，澳門有幾多人？</h2>

人口係某一時點嘅人數。討論交通、醫療或社區服務時，仲要了解年齡、地區分布同服務使用情況。
